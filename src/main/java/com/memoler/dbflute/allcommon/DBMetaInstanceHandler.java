package com.memoler.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("INFO", "com.memoler.dbflute.bsentity.dbmeta.InfoDbm");
        tmpMap.put("MEMBER", "com.memoler.dbflute.bsentity.dbmeta.MemberDbm");
