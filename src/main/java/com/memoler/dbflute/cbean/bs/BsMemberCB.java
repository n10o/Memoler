...
public class BsMemberCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
         ...
         * {select max(FOO) from INFO where ...) as FOO_MAX} <br />
         * INFO by MEMBER_ID, named 'infoList'.
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedInfoList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;InfoCB&gt;() {
         *     public void query(InfoCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, Info.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<InfoCB, MemberCQ> derivedInfoList() {
            assertDerived("infoList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<InfoCB, MemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<InfoCB, MemberCQ>() {
                public void setup(String function, SubQuery<InfoCB> subQuery, MemberCQ cq, String aliasName, DerivedReferrerOption option) {
                    cq.xsderiveInfoList(function, subQuery, aliasName, option); } }, _dbmetaProvider);
        }
        /**
