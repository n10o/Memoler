...
/**
 * The condition-query for in-line of INFO.
 * @author DBFlute(AutoGenerator)
 */
public class InfoCIQ extends AbstractBsInfoCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsInfoCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public InfoCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsInfoCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue getCValueInfoId() { return _myCQ.getInfoId(); }
    ...
    protected ConditionValue getCValueInfoName() { return _myCQ.getInfoName(); }
    ...
    protected String xinCB() { return InfoCB.class.getName(); }
    protected String xinCQ() { return InfoCQ.class.getName(); }
}
